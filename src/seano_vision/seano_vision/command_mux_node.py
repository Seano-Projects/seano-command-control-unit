...
class CommandMuxNode(Node):
    def __init__(self):
        ...
        # Output ke /seano/selected/* agar diproses safety limiter dulu
        # sebelum sampai ke mavros_rc_override_bridge
        self.declare_parameter("out_left_topic", "/seano/selected/left_cmd")
        self.declare_parameter("out_right_topic", "/seano/selected/right_cmd")
